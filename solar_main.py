...
def open_file_dialog():
    ...
    in_filename = dialog.askopenfilename(filetypes=(("Text file", ".txt"),))
    space_objects = sinput.read_space_objects_data_from_file(in_filename)
...
def save_file_dialog():
    ...
    Считанные объекты сохраняются в глобальный список space_objects
    """
    out_filename = dialog.asksaveasfilename(filetypes=(("Text file", ".txt"),))
    sinput.write_space_objects_data_to_file(out_filename, space_objects)
